...
class SentenzaAdmin(admin.ModelAdmin):
	inlines = [
		ProfiloRilevanteInline,
	]
	fieldsets = (
		('Stato rilettura', {
			'fields': ('forza_esclusione',)
		}),
		(None, {
			'fields': ('esaminatore', 'osservatorio')
		}),
		('Dati sentenza', {
			'fields': (
				('anno_di_arrivo', 'numero_della_sentenza', 'estctu'), ('provenienza', 'codice', 'estensore'),
				('grado_di_giudizio', 'sede_tribunale', 'numero_della_sezione'), ('data_della_citazione', 'data_della_sentenza'),
		...
		(None, {
			'fields': ( 
				('note_profili_rilevanti'),
			)
		}),
	)
	filter_horizontal = ('esaminatore',)
	list_display = ('id', 'forza_esclusione', 'codice', 'grado_di_giudizio', 'sede_tribunale', 'data_della_sentenza', 'data_della_citazione', 'data_del_fatto', 'files_allegati')
	list_display_links = ('id', 'sede_tribunale', 'data_della_sentenza', 'data_della_citazione', 'data_del_fatto')
...
#	interessi_legali_ss		DipendeDa_est_ss
		...
		CampiControllo = ['est_it','est_ip','est_lcit','est_dm','est_dmip','est_dmit','est_ss']
		
		DipendeDa = {
			'est_it':	['metodo_das_it', 'euro_al_di', 'importo_liquidazione_das_it','interessi_legali_it', 'est_lcit', 'note_it'],
			'est_lcit':	['giorni_lcit', 'metodo_lcit', 'importo_liquidazione_lcit', 'interessi_legali_lcit'],
			'est_ip':	['percentuale_das_ip', 'metodo_das_ip', 'tabella', 'sede_tabella', 'importo_liquidazione_das_ip', 'interessi_legali_ip', 'est_lcip', 'note_ip'],
			'est_lcip':	['metodo_lcip', 'percentuale_lcip', 'importo_liquidazione_lcip', 'interessi_legali_lcip', 'est_clg', 'est_cls'],
			...
			'est_dm':	['motivazione', 'est_dm_vp', 'est_dm_it', 'est_dm_ip', 'note_dm', 'interessi_legali_dm'],
	...
	inlines = [
		...
		('Generale', {
			...
			'fields': (
				...
				('fattori_rilevanti_liquidazione','note_fattori_rilevanti_liquidazione'),
				('prova_del_dnp','note_prova_del_dnp'),
				('fattori_rilevanti_liquidazione_dp','note_fattori_rilevanti_liquidazione_dp'),
				('prova_del_dp','note_prova_del_dp'),
				('trend_liquidazione','est_rdjh','est_interazione','note_trend_liquidazione','est_pddb','percentuale_pddb')
			)
		}),
		...
		('Danno non patrimoniale diverso dal danno alla salute', {
			...
			'fields': (
				...
				('sunt_diritti_lesi'),
				('dirittoinviolabile'),
				('importo_dirittoinviolabile', 'interessi_dirittoinviolabile', 'metodo_di_quantificazione'),
		...
		('Danni da morte', {
			...
			'fields': (
				('dm_est'),
				('dm_dbjh_est', 'dm_dbjh_importo_liquidazione', 'periodo_di_sopravvivenza', 'criterio_liquidazione'),
			#	('est_de', 'importo_liquidazione_de', 'interessi_legali_de'),
			#	('note_morte')
			)
		}),
...
#		}),
	...
	filter_horizontal = ('richiestaparteattrice','dannopatrimoniale','dirittoinviolabile','fattori_rilevanti_liquidazione_dp','fattori_rilevanti_liquidazione','prova_del_dnp','prova_del_dp','trend_liquidazione')
	save_on_top = True
